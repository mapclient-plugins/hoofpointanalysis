...
from mapclientplugins.hoofpointanalysisstep.configuredialog import ConfigureDialog
from mapclientplugins.hoofpointanalysisstep.analyze import PointAnalyzer


class HoofPointAnalysisStep(WorkflowStepMountPoint):
    '''
    ...
    def execute(self):
        ...
        locations = self._portData0['locations']
        self._portData1 = {}
